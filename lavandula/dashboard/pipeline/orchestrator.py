...
"state": {"type": "text", "pattern": r"^[A-Z]{2}$", "flag": "--state"},
    ...
    "reclassify": {
        ...
        "params": {
            ...
            "definition": {"type": "text", "pattern": r"^[a-z][a-z0-9_]*$", "flag": "--definition"},
            "allow_fallback": {"type": "bool", "flag": "--allow-fallback"},
            "min_text_len": {"type": "int", "min": 0, "max": 10000, "flag": "--min-text-len"},
            "batch_size": {"type": "int", "min": 10, "max": 5000, "flag": "--batch-size"},
            "quiet": {"type": "bool", "flag": "--quiet"},
        },
    },
    "resolve-disagree": {
        "cmd": ["python3", "lavandula/dashboard/manage.py", "resolve_disagreements"],
        "params": {
            "run_tag": {"type": "text", "pattern": r"^[a-zA-Z0-9][a-zA-Z0-9_-]*$", "flag": "--run-tag"},
            "backend": {"type": "choice", "choices": ["deepseek", "claude", "gemini", "codex"], "flag": "--backend"},
            "state": {"type": "text", "pattern": r"^[A-Z]{2}$", "flag": "--state"},
