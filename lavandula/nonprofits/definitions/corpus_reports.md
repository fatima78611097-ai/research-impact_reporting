...
- For documents that could be either financial_report or not_relevant: standalone financial statements are financial_report. IRS Form 990s are not_relevant (we get them directly from IRS). Budget worksheets, grant applications, and tax filing instructions are not_relevant.
